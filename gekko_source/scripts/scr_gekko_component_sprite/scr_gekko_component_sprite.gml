...
function GekkoComponentSprite(_sprite_index, _image_index, _anchor_point, _anchor_offset_x, _anchor_offset_y, _parent) : GekkoComponentAbstract(_parent, _anchor_point, _anchor_offset_x, _anchor_offset_y) constructor {
	...
	#region Private =====================================================================
		...
		add_animated_properties(["opacity"]);
		...
		static draw_component = function() {
			draw_sprite_ext(get_sprite(), get_image_index(), get_draw_x() + get_draw_sprite_offset_x(), get_draw_y() + get_draw_sprite_offset_y(), 1, 1, 0, get_color(), __.opacity);
		}
	...
	// Public ===========================================================================
		...
		///@desc Sets the Opacity for the component
		///@param {Real} opacity
		///@self GekkoComponentSprite
		///@return {Struct.GekkoComponentText} self
		static set_opacity = function(_alpha) {
			__.opacity = _alpha;
			return self;
		}
		
		///@desc Sets the target Opacity for the component
		///@param {Real} opacity
		///@self GekkoComponentSprite
		///@return {Struct.GekkoComponentText} self
		static set_target_opacity = function(_alpha) {
			__.target_opacity = _alpha;
			return self;
		}
