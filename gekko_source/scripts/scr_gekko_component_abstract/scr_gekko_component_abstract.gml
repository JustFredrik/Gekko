...
function GekkoComponentAbstract(_parent, _anchor_point, _anchor_offset_x, _anchor_offset_y) constructor {
	...
	// Public =====================================================================================
		...
		static is_visible = function() {
			var _vis = __.visible;
			if has_parent() {
				_vis = _vis && get_parent_is_visible();
			}
			return _vis;
		}
		...
		static get_parent_is_visible = function() {
			if has_parent(){
				return __.parent.is_visible() && __.parent.get_parent_is_visible();
			}
			return true;
		} 
		...
		static get_anchor_offset_x = function() {
			...
			return __.anchor_offset_x * get_parent_scale();
		}	
		...
		static get_anchor_offset_y = function() {
			...
			return __.anchor_offset_y * get_parent_scale();
		}	
